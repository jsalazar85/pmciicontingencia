angular
    ...
    .controller('tableroSeguimientoGlobalCtrl', [
        ...
        'uiGridConstants',
        '$http',
        tableroSeguimientoGlobalCtrl
    ]);

function tableroSeguimientoGlobalCtrl ($scope,$rootScope,$state,$stateParams,dc,gc,ngProgressFactory,dss,cs,$interval,tools,cds,uiGridConstants,$http)  {
