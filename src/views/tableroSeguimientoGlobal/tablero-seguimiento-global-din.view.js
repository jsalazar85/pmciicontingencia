angular
    ...
    .controller('tableroSeguimientoGlobalDinCtrl', [
        ...
        tableroSeguimientoGlobalDinCtrl
    ]);

function tableroSeguimientoGlobalDinCtrl ($scope,$rootScope,$state,$stateParams,dc,gc,ngProgressFactory,dss,cs,$interval,tools,cds,uiGridConstants,$http,gridFactory)  {
...
*/        ],
    ...
    $scope.createDetalleColums=function () {
        //Obtener detalle
        cds.addWorkTask('tableroSeguimientoGlobalDinCtrl.createDetalleColumns',{
            ...
            success:function (response) {
                ...
                var cols=gridFactory.createColumunsIniciativa(response.data,[]);
                var newCols=[];
        ...
        cds.doWorkTask('tableroSeguimientoGlobalDinCtrl.createDetalleColumns');
    };
